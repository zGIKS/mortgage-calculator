...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/resources.CreateProfileResource"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/profile/reniec": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "DNI number (8 digits)",
                        "name": "dni",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/resources.ReniecDataResource"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "resources.CreateProfileResource": {
            "type": "object",
            "required": [
                "currency",
                "dni",
